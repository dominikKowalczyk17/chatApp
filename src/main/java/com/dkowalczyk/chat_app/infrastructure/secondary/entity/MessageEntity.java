...
import com.dkowalczyk.chat_app.infrastructure.secondary.entity.MessageEntityBuilder;
import com.dkowalczyk.chat_app.infrastructure.secondary.entity.UserEntityBuilder;
import com.dkowalczyk.chat_app.messaging.domain.message.aggregate.Message;
import com.dkowalczyk.chat_app.messaging.domain.message.aggregate.MessageBuilder;
...
public class MessageEntity extends AbstractAuditingEntity<Long> {
    ...
    public MessageEntity(Long id, UUID publicId, Instant sendTime, String text, MessageType type, MessageSendState sendState, UserEntity sender, ConversationEntity conversation, MessageContentBinaryEntity contentBinary) {
        this.id = id;
