...
import com.dkowalczyk.chat_app.messaging.domain.user.aggreagate.UserBuilder;
...
public class UserEntity extends AbstractAuditingEntity<Long> {
    ...
    private Set<ConversationEntity> conversation = new HashSet<>();

    public UserEntity(long id, String lastName, String firstName, String email, String imageUrl, UUID publicId, Instant lastSeen, Set<AuthorityEntity> authorities, Set<ConversationEntity> conversation) {
        this.id = id;
    ...
    public static UserEntity from(User user) {
        com.dkowalczyk.chat_app.infrastructure.secondary.entity.UserEntityBuilder userEntityBuilder = com.dkowalczyk.chat_app.infrastructure.secondary.entity.UserEntityBuilder.userEntity();
    ...
    public static Set<User> toDomain(Set<UserEntity> userEntities) {
    ...
    public boolean equals(Object o) {
        ...
        return id == that.id && Objects.equals(lastName, that.lastName) && Objects.equals(firstName, that.firstName) && Objects.equals(email, that.email) && Objects.equals(imageUrl, that.imageUrl) && Objects.equals(publicId, that.publicId) && Objects.equals(lastSeen, that.lastSeen);
    }
